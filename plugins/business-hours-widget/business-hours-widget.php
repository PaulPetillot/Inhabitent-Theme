 ...
 * Description:       A nitfy business hours widget built custom for the Inhabitent site.
 * Version:           1.0.0
 * Author:            Paul Petillot
 * Author URI:        https://github.com/PaulPetillot
 * License:           GPL-2.0+
...
class Biz_Hours extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'biz_hours';
